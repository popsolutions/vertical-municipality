CREATE OR REPLACE FUNCTION public.account_invoice_accumulated_calc_multa(_invoice_id integer)
...
*/
  ...
  select sum(v.pric_total) pric_total,
    ...
    from account_invoice_accumulated_calc_multa_lines(_invoice_id) v;
END;
$function$
;
