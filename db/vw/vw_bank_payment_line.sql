CREATE OR REPLACE VIEW public.vw_bank_payment_line AS
 SELECT apo.id AS account_payment_order_id,
   ...
   FROM bank_payment_line bpl
        ...
        LEFT JOIN l10n_br_cnab_return_event cre ON cre.invoice_id = ai.id;